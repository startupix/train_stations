...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { address: @station.address, beverage_store: @station.beverage_store, description: @station.description, name: @station.name, phone: @station.phone, timetable: @station.timetable }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { address: @station.address, beverage_store: @station.beverage_store, description: @station.description, name: @station.name, phone: @station.phone, timetable: @station.timetable }
    assert_redirected_to station_path(assigns(:station))
  end
